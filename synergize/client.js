...
function init(bundle, parent, options = {}) {
  ...
  const filterSurface = new Surface(1000, 600, Surface.SurfaceShape.Flat);
  const lightSurface = new Surface(1000, 600, Surface.SurfaceShape.Flat);
  ...
  filterSurface.setAngle((2 * Math.PI) / 32, (0.7 * Math.PI) / 16);
  lightSurface.setAngle((-24 * Math.PI) / 32, (4 * Math.PI) / 16);

  const paperTowelSurface = new Surface(1000, 600, Surface.SurfaceShape.Flat);

  paperTowelSurface.setAngle((12 * Math.PI) / 32, (1 * Math.PI) / 32);

  const counterSurface = new Surface(1000, 600, Surface.SurfaceShape.Flat);

  counterSurface.setAngle((0 * Math.PI) / 32, (-3 * Math.PI) / 8);

  const pictureSurface = new Surface(1000, 600, Surface.SurfaceShape.Flat);

  pictureSurface.setAngle((-95 * Math.PI) / 100, (1.5 * Math.PI) / 10);
  ...
  r360.renderToSurface(r360.createRoot("filter"), filterSurface);
  r360.renderToSurface(r360.createRoot("paperTowel"), paperTowelSurface);
  r360.renderToSurface(r360.createRoot("counter"), counterSurface);
  r360.renderToSurface(r360.createRoot("picture"), pictureSurface);
  r360.renderToSurface(r360.createRoot("light"), lightSurface);
